...
if apply_external_force
    ...
    output_file_path = fullfile(path_to_opensim, 'ExternalLoads', [participant '_ExpTrial_2_4kmh_45W_ExternalForce_C7.sto']);
    data_storage = Storage(output_file_path);
    data_storage.setName([participant '_ExpTrial_2_4kmh_45W_ExternalForce_C7.sto']);
